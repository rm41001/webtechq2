...
<?php  //this is what creates everything!!!
	...
	if (mysqli_num_rows($result) == 0) {//checks to see if username is not there
		echo "<h3>You do not exist, please proceed to the registration page by clicking the link below.</h3>";
		echo "<a href='notregistered.html' name='Proceed' class=button>";
	} 
	else {
